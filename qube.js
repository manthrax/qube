export default function Qube(THREE, scene, loader) {
    ...
    status.innerText = "QUBE!"
    status.style = "color:white;position:absolute;left:30px;top:30px;font-family:Arial"
    ...
    let rbk = glb=>{
        ...
        qube.traverse(e=>{
            ...
            if(e.material){e.material.metalness=.8;e.material.roughness=.2;}});
